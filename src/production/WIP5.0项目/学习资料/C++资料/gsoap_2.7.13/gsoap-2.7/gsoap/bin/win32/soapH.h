...
#ifndef SOAP_TYPE_ns__helloword
#define SOAP_TYPE_ns__helloword (13)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__helloword(struct soap*, struct ns__helloword *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__helloword(struct soap*, const struct ns__helloword *);

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__helloword(struct soap*, const struct ns__helloword *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__helloword(struct soap*, const char*, int, const struct ns__helloword *, const char*);
SOAP_FMAC3 struct ns__helloword * SOAP_FMAC4 soap_get_ns__helloword(struct soap*, struct ns__helloword *, const char*, const char*);
SOAP_FMAC3 struct ns__helloword * SOAP_FMAC4 soap_in_ns__helloword(struct soap*, const char*, struct ns__helloword *, const char*);

#define soap_new_ns__helloword(soap, n) soap_instantiate_ns__helloword(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__helloword(soap, p) soap_delete(soap, p)

SOAP_FMAC3 struct ns__helloword * SOAP_FMAC4 soap_instantiate_ns__helloword(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__helloword(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns__hellowordResponse
#define SOAP_TYPE_ns__hellowordResponse (12)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__hellowordResponse(struct soap*, struct ns__hellowordResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__hellowordResponse(struct soap*, const struct ns__hellowordResponse *);

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__hellowordResponse(struct soap*, const struct ns__hellowordResponse *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__hellowordResponse(struct soap*, const char*, int, const struct ns__hellowordResponse *, const char*);
SOAP_FMAC3 struct ns__hellowordResponse * SOAP_FMAC4 soap_get_ns__hellowordResponse(struct soap*, struct ns__hellowordResponse *, const char*, const char*);
SOAP_FMAC3 struct ns__hellowordResponse * SOAP_FMAC4 soap_in_ns__hellowordResponse(struct soap*, const char*, struct ns__hellowordResponse *, const char*);

#define soap_new_ns__hellowordResponse(soap, n) soap_instantiate_ns__hellowordResponse(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__hellowordResponse(soap, p) soap_delete(soap, p)

SOAP_FMAC3 struct ns__hellowordResponse * SOAP_FMAC4 soap_instantiate_ns__hellowordResponse(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__hellowordResponse(struct soap*, int, int, void*, size_t, const void*, size_t);
