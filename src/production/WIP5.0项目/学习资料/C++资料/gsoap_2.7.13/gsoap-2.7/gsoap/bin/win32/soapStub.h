...
struct ns__hellowordResponse
{
public:
	char *pResult;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:string */
};
#endif
...
SOAP_FMAC5 int SOAP_FMAC6 ns__helloword(struct soap*, char *pResult);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_ns__helloword(struct soap*);
